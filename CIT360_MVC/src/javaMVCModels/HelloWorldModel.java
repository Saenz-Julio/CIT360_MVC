...
public class HelloWorldModel {
    public String getData() throws FileNotFoundException, IOException {
        ...
        if(!(new File("C:\\Users\\jsaenz\\Documents\\Temp\\file.txt").isFile())) {
            // Create -- Make sure file exists -- the file before continuing
            Files.createFile(Paths.get("C:\\Users\\jsaenz\\Documents\\Temp\\file.txt"));
        }
        
        String data;
        // We will be using a try-with-resource block
        try (BufferedReader reader = new BufferedReader(
                new FileReader("C:\\Users\\jsaenz\\Documents\\Temp\\file.txt"))) {
    ...
    public boolean writeData(String data) throws IOException, FileNotFoundException
    {
        ...
        try (BufferedWriter writer = new BufferedWriter(
                                        new FileWriter("C:\\Users\\jsaenz\\Documents\\Temp\\file.txt"))) {
